...
**
** Created: Sun 10. Jan 02:18:43 2010
...
public:
    ...
    void setupUi(QMainWindow *GameWindow)
    {
        ...
        playerSignLabel = new QLabel(centralWidget);
        playerSignLabel->setObjectName(QString::fromUtf8("playerSignLabel"));
        playerSignLabel->setFont(font2);
        playerSignLabel->setFrameShape(QFrame::StyledPanel);

        gridLayout->addWidget(playerSignLabel, 1, 2, 1, 2);
    ...
    void retranslateUi(QMainWindow *GameWindow)
    {
        ...
        playerSignLabel->setText(QString());
